    ...
    <header className="sticky top-0 z-10 w-full border-b bg-background">
      <div className="flex h-16 items-center justify-between px-4 md:px-6">
        ...
        <div className="flex items-center gap-4">
          ...
          {/* Mobile menu button */}
          <button
            className="md:hidden flex items-center justify-center p-2 rounded-md text-gray-700 hover:text-primary focus:outline-none"
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-background border-b">
          <div className="px-4 py-3 space-y-1">
            ...
            {/* Mobile user profile */}
            <div className="flex items-center gap-2 py-2 px-3 mt-4 border-t pt-4">
              <div className="h-8 w-8 rounded-full bg-muted overflow-hidden">
                <Image src="/placeholder.svg?height=32&width=32" alt="User Avatar" width={32} height={32} />
              </div>
              <span className="text-sm font-medium">Adebimpe Ibrahim</span>
